  ...
  return (
    <div className="bg-yellow-400 p-3 text-start ">
      <div className="flex flex-col md:flex-row md:justify-around">
        ...
        <div className="m-4 md:m-auto md:border-l md:border-black md:pl-4">
          <h4 className="text-2xl">EMPRESA</h4>
          <p>Aviso legal</p>
