...
const Carousel = () => {
  ...
  return (
    ...
    >
      {/* Carousel wrapper */}
      <div className=" h-48 md:h-72 overflow-hidden transform transition-transform  hover:scale-105 ">
        {/* Item 1 */}
        <div
          className={`bg-gradient-to-t from-white to-yellow-400 absolute block w-full transition-opacity duration-700 ease-in-out  ${
        ...
        {/* Item 2 */}
        <div
          className={`bg-gradient-to-t from-white to-red-600 absolute block w-full transition-opacity duration-700 ease-in-out  ${
        ...
        {/* Item 3 */}
        <div
          className={`bg-gradient-to-t from-white to-black absolute block w-full transition-opacity duration-700 ease-in-out  ${
